...
# Gemini API 配置
GEMINI_MODEL = "gemini-1.5-pro"  # 最新可用的 flash 模型
GEMINI_TEMPERATURE = 0.4
GEMINI_MAX_OUTPUT_TOKENS = 2048  # 增加到 2048 确保有足够空间输出完整分析

# 速率控制
REQUEST_DELAY_SECONDS = 12  # Gemini API 请求间隔（免费层限制 15 RPM，留足余量）
